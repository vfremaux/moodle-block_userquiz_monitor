...
class block_userquiz_monitor_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        $mform->addHelpButton('config_informationpageid', 'configinfopageid', 'block_userquiz_monitor');
        $mform->setType('config_informationpageid', PARAM_INT);

        if (block_userquiz_monitor_supports_feature('series/dualseries')) {
            $label = get_string('confignameaserie', 'block_userquiz_monitor');
            $mform->addElement('text', 'config_nameAserie', $label);
            $mform->addHelpButton('config_nameAserie', 'confignameserie', 'block_userquiz_monitor');
            $mform->setType('config_nameAserie', PARAM_TEXT);
        }

        $label = get_string('configrateaserie', 'block_userquiz_monitor');
        $mform->addElement('text', 'config_rateAserie', $label);
        $mform->addHelpButton('config_rateAserie', 'configrateserie', 'block_userquiz_monitor');
