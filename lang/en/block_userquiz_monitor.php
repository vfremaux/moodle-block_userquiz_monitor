...
$string['commenthist'] = 'Results history : ';
...
$string['examinstructions'] = '<p>The Bärchen review simulates almost exact {$a} examination.</p><p>When you launch an attempt, you <b>must complete the review by going through issues</b>, or attempted to be little signficative and may distort your readiness assessment. So plan enough time to respond to 100 questions on the exam without being disturbed.</p><p>You have by your subscription, a limited number of examinations. Train yourself so enough to enjoy each simulation.</p>';
...
$string['total'] = 'Total';
$string['totaldesc'] = 'These results are calculated on all topics and show you your average success rate with the trainings throughout the review period since the last reset.';
