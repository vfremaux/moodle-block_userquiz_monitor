...
function call_attempts($test_data, $data ) {
    ...
    $response.=         '<param name="movie" value="'.$CFG->wwwroot.'/blocks/userquiz_monitor/generators/attempts.swf" />';
    ...
    $response.=         '<embed src="'.$CFG->wwwroot.'/blocks/userquiz_monitor/generators/attempts.swf" quality="high" bgcolor="#ffffff"';
